...
def submit_circuit(script_path, full_circuit=False):
    """
...
def schedule_submissions(script_path, start_time_str, end_time_str, interval_minutes, api_key=None, crn=None, full_circuit=False):
    """
    ...
    try:
        ...
        for t in submission_times:
            if not wait_until(t):
                ...
                break
            print(f"\nExecuting submission at {t.strftime('%H:%M:%S')}...")
